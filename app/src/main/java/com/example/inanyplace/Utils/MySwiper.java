...
import com.example.inanyplace.Callback.IButtonClickListener;
...
public abstract class MySwiper extends ItemTouchHelper.SimpleCallback {
    ...
    public MySwiper(Context context, RecyclerView recyclerView, int buttonWidth) {
    ...
    public class MyButton {
        ...
        public MyButton(Context context, String text, int textSize, int imageResId, int color, IButtonClickListener listener) {
            this.text = text;
